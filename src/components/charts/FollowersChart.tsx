      ...
      <div className="space-y-1">
        ...
        {payload[1]?.value > 0 && (
          <p className="text-emerald-400 text-xs">
            +{payload[1]?.value?.toLocaleString('pt-BR')} novos
          </p>
        )}
      </div>
    </div>
  ...
  return (
    <div className="glass rounded-2xl p-6">
      <div className="mb-6">
        ...
        <p className="text-white/40 text-xs mt-0.5">Evolução mensal do total de seguidores</p>
      </div>
      <ResponsiveContainer width="100%" height={220}>
        <AreaChart data={data} margin={{ top: 5, right: 5, bottom: 5, left: 5 }}>
          ...
          <Area type="monotone" dataKey="followers" stroke="#f97316" strokeWidth={2}
